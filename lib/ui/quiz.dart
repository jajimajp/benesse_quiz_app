...
class _QuizAppState extends State<QuizApp> {
  ...
  List<Question> questionBank = [
    ...
    Question.name(AnswerOption.B, 'https://placehold.jp/150x150.png', 'https://placehold.jp/150x150.png'),
  ];
  ...
  Future<void> _dialogBuilder(BuildContext context, AnswerOption userChoice) {
    final isCorrect = userChoice == questionBank[_currentQuestionIndex].correctAnswer;
